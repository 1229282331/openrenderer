...
- 延迟渲染 gbuffer（position+depth+normal+albedo）
  <center class="half">
  	<img src="./results/gbuffer_marry_pos.png" alt="gbuffer_marry_pos" width="150" />
  	<img src="./results/gbuffer_marry_depth.png" alt="gbuffer_marry_depth" width="150" />
      <img src="./results/gbuffer_marry_normal.png" alt="gbuffer_marry_normal" width="150" />
      <img src="./results/gbuffer_marry_albedo.png" alt="gbuffer_marry_albedo" width="150" />
  </center>
